...
ActiveRecord::Schema.define(version: 20150910000248) do
  ...
  add_index "taggings", ["topic_id", "url_id"], name: "index_taggings_on_topic_id_and_url_id", unique: true, using: :btree
